        ...
        <div style={{ backgroundColor: "#262626" }} className="rounded-lg p-6 shadow border border-gray-700">
              ...
              <tbody className="divide-y divide-gray-700">
                <tr className="border-b border-gray-700">
                  ...
                  <td className="px-3 py-2 text-xs border-r border-gray-700">
                    <span className="bg-transparent py-0.5 px-2 rounded-full text-green-400 text-xs border border-green-600">
                      In Stock
                    </span>
                  </td>
                ...
                <tr className="border-b border-gray-700">
                  ...
                  <td className="px-3 py-2 text-xs border-r border-gray-700">
                    <span className="bg-transparent py-0.5 px-2 rounded-full text-yellow-400 text-xs border border-yellow-600">
                      Low Stock
                    </span>
                  </td>
                  <td className="px-3 py-2 text-xs text-center">
                ...
                <tr>
                  ...
                  <td className="px-3 py-2 text-xs border-r border-gray-700">
                    <span className="bg-transparent py-0.5 px-2 rounded-full text-red-400 text-xs border border-red-600">
                      Out of Stock
                    </span>
                  </td>
                  <td className="px-3 py-2 text-xs text-center">
          ...
          <div className="flex items-center justify-between px-3 py-1.5 border-t border-gray-700">
            ...
            <div className="inline-flex items-center gap-1">
              ...
              <button className="w-5 h-5 flex items-center justify-center rounded text-xs bg-blue-600 text-white">1</button>
              <button className="w-5 h-5 flex items-center justify-center rounded text-xs text-gray-400 hover:bg-gray-700">2</button>
              <button className="w-5 h-5 flex items-center justify-center rounded text-xs text-gray-400 hover:bg-gray-700">3</button>
